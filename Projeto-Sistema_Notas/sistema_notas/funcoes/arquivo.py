...
def salvar_nota(turma, aluno, nota1, nota2, nota3, nota4):
    """
...
def ler_notas(turma):
    ...
    if not os.path.exists(caminho_arquivo):
        print(f"Não há registros para a turma '{turma}'.")
        return
    ...
    for registro in dados:
        ...
        print(f"Nota 1: {registro['nota1']}  |  Nota 2: {registro['nota2']}  |  Nota 3: {registro['nota3']}  |  Nota 4: {registro['nota4']}")
