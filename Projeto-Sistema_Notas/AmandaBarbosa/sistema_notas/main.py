...
def obter_turma():
    ...
    while True:
            ...
            if nome_turma.lower() == "sair":
                return None
            if (validar_turma(nome_turma)):
                 return nome_turma
            else:
                 print("Erro ao digitar o nome da turma")
...
def obter_aluno():
    ...
    while True:
            ...
            if (validar_aluno(nome_aluno)):
                 ...
                 print("Erro ao digitar o nome do aluno")
...
def obter_nota(numero_da_nota):
    ...
    while True:
         nota_aluno = input(f"Digite a {numero_da_nota} º/ª nota do aluno: ")
         nota_validada = validar_nota(nota_aluno)
         if nota_validada is None:
              print("Erro ao cadastrar a nota")
         else:
...
def main():
    ...
    while True:
        ...
        print(f"\n Notas de {aluno} foram salvas com sucesso!")

        print("\n=== REGISTROS ATUAIS DA TURMA ===")
        ler_notas(turma)
        print("=" * 33 + "\n")
