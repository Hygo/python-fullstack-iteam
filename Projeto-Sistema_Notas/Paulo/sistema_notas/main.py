...
def obter_turma():
    ...
    while True:
        ...
        if validar_turma(turma):
            return turma
        print("Erro: Turma inválida. Não pode ser vazia.")
...
def obter_aluno():
    ...
    while True:
        ...
        if validar_aluno(aluno):
            return aluno
        print("Erro: Nome inválido. Digite pelo menos duas palavras (nome e sobrenome).")
...
def obter_nota(numero_da_nota):
    ...
    while True:
        ...
        if nota is not None:
            return nota
        print("Erro: Nota inválida. Digite um número entre 0.0 e 10.0.")
...
def main():
    ...
    # Passo 1: Obtém a turma
    turma = obter_turma()
    if turma is None:
        print("\nEncerrando o sistema. Até logo!")
        return

    # Passo 2: Cadastro de alunos
    while True:
        aluno = obter_aluno()
        if aluno is None:
            break
