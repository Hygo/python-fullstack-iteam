...
class ItemBiblioteca:
    ...
    def __eq__(self, outro):
        ...
        return self.__codigo == outro.codigo
...
class Livro(ItemBiblioteca):
    ...
    def info_completa(self):
        ...
        # Tipo, Código, Título, Autor, ISBN, Ano, Páginas, Disponibilidade7
        status = "✅ Disponível" if self.disponivel else "❌ Emprestado"
        print(f"""
...
class Revista(ItemBiblioteca):
    ...
    def info_completa(self):
        ...
        Número da Edição:  {self.numero_edicao}
...
class Pessoa:
    ...
    def registrar_emprestimo(self, item):
        ...
        if self.pode_emprestar():
            if item.disponivel:
                ...
                print("Não é possível emprestar este livro, pois ele já está emprestado.")
                return False
        else:
            print("Você não pode mais fazer emprestimos, pois já atingiu o limite de empréstimos.")
            return False
    ...
    def registrar_devolucao(self, item):
        ...
        if item in self._emprestimos_ativos:
            ...
            print("Este livro, não estava registrado nos seus empréstimos.")
            return False
    ...
    def listar_emprestimos(self):
        ...
        if len(self._emprestimos_ativos) == 0:
            print("Você não realizou nenhum empréstimo ainda.")
        else:
...
class Biblioteca:
    ...
    def adicionar_item(self, item):
        ...
        if item not in self.__acervo:
            ...
            print("Item adicionado ao acervo com sucesso.")
        else:
            print("O item informado já existe no acervo.")
    ...
    def cadastrar_membro(self, pessoa):
        ...
        if pessoa not in self.__membros:
            self.__membros.append(pessoa)
            print("Novo membro cadastrado com sucesso.")
        else:
...
if __name__ == "__main__":
    ...
    revista2 = Revista("R002", "Java Magazine", 2024,
                       "Tech Press", 42, "Mensal")
    ...
    biblioteca.adicionar_item(revista2)
    ...
    biblioteca.realizar_emprestimo(aluno, "R002")
    biblioteca.realizar_emprestimo(aluno, "R002")
