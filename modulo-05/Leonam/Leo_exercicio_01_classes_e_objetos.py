...
class Aluno:
    ...
    def __init__(self, nome, idade, matricula):
        ...
        self.nome = nome         # substitua None pelo parâmetro correto
        self.idade = idade         # substitua None pelo parâmetro correto
        self.matricula = matricula     # substitua None pelo parâmetro correto
    ...
    def adicionar_nota(self, nota):
        ...
        if 0 <= nota <= 10:
            ...
            print(f"Erro: A nota {nota} deve estar entre 0 e 10.")
    ...
    def calcular_media(self):
        ...
        if self.notas:            
            ...
            media = 0.0  # substitua 0.0 pelo cálculo correto da média
        return media
...
if __name__ == "__main__":
    ...
    # Criando 2 objetos da classe Aluno com dados diferentes
    aluno1 = Aluno("Leonam Silva", 22, "2026001")
    aluno2 = Aluno("Raquel Sofia", 20, "2026002")

    print("\n--- Adicionando notas para Aluno 1 ---")
    aluno1.adicionar_nota(8.5)
    aluno1.adicionar_nota(7.0)
    aluno1.adicionar_nota(9.0)

    print("\n--- Adicionando notas para Aluno 2 ---")
    ...
    print("\n--- DESAFIO: Testando Nota Inválida ---")
    
    aluno1.adicionar_nota(11.5)
    aluno1.adicionar_nota(-2.0)
