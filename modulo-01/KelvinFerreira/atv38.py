...
# Função genérica aplicar_transformacao demonstrada com três casos distintos.
...
usuarios = [
    {"nome": "Kelvin",   "cargo": "Dev"},
    {"nome": "Fernanda", "cargo": "Engenheira"},
    {"nome": "Lucas",    "cargo": "Designer"},
]
