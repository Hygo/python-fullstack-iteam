...
# Sistema de cadastro de alunos com persistência em JSON, type hints e docstrings Google Style.
...
cadastrar_aluno("Kelvin Araújo",  "kelvin@aluno.com",   22, [9.5, 8.0, 10.0])
cadastrar_aluno("Fernanda Costa", "fernanda@aluno.com", 24, [7.5, 8.5,  9.0])
cadastrar_aluno("Lucas Mendes",   "lucas@aluno.com",    21, [6.0, 7.0,  6.5])
cadastrar_aluno("Ana Lima",       "ana@aluno.com",      23, [10.0, 9.5, 9.0])
