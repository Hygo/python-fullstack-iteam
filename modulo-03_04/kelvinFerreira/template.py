...
Aluno(a): Kelvin Araújo Ferreira
Data    : 26/05/2026
=============================================================
...
# ------------------------------------------------------------
Q01 = "B"   # lista final: ["maçã","abacaxi","uva","laranja","manga"] → [-2] = "laranja"
...
# ------------------------------------------------------------
Q02 = "C"   # tuplas são imutáveis — qualquer tentativa de atribuição levanta TypeError
...
# E) "Ana"
# ------------------------------------------------------------
Q03 = "C"   # "email" não existe → .get() retorna o segundo argumento
...
# E) 6
# ------------------------------------------------------------
Q04 = "D"   # únicos: {1,2,3,4,5,6,9} → 7 elementos
...
# E) [9.0, 7.0]
# ------------------------------------------------------------
Q05 = "B"   # após sort desc: [9.0,8.5,7.0,6.0,5.5] → [1:3] = [8.5, 7.0]
...
# E) []
# ------------------------------------------------------------
Q06 = "C"   # apenas "borracha" tem qtd == 0
...
# E) [1, 9, 25, 49, 81]
# ------------------------------------------------------------
Q08 = "B"   # pares 2,4,6,8,10 → quadrados 4,16,36,64,100
...
# E) []
# ------------------------------------------------------------
Q10 = "C"   # Carlos=8.0 ✓, Beatriz≈9.67 ✓, Diego=5.0 ✗
...
# ------------------------------------------------------------
Q11 = "C"   # função sem return → retorna None implicitamente
...
# E) None e None
# ------------------------------------------------------------
Q12 = "C"   # 1ª chamada usa default "Olá"; 2ª sobrescreve com "Bom dia"
...
# ------------------------------------------------------------
Q13 = "C"   # x=99 é local à função; x global permanece 10
...
# E) 8
# ------------------------------------------------------------
Q15 = "B"   # dobrar aplicado a cada elemento: [2,4,6,8]
...
# ------------------------------------------------------------
Q17 = "A"   # info["CARGO"]="Professor"; __doc__[:10]="Registra i"
