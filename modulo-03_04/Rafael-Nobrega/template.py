...
# ------------------------------------------------------------
Q01 = "B"   
# A lista começa como ["maçã", "banana", "uva", "laranja"].
# Depois "banana" vira "abacaxi" e "manga" é adicionada no final.
# Resultado final:
# ["maçã", "abacaxi", "uva", "laranja", "manga"]
# O índice -2 pega o penúltimo elemento da lista → "laranja".
...
# ------------------------------------------------------------
Q02 = "C"
# Tuplas são imutáveis, ou seja, não podem ser alteradas após serem criadas.
# Quando o código tenta fazer coordenadas[1] = 99,
# o Python gera um TypeError.
...
# ------------------------------------------------------------
Q03 = "C"
# O método .get() tenta buscar a chave "email".
# Como ela não existe no dicionário, o valor padrão é retornado:
# "não informado".
# Diferente de acessar aluno["email"], o .get() não gera erro.
...
# ------------------------------------------------------------
Q04 = "D" 
# O set() remove valores duplicados.
# Lista original:
# [3, 1, 4, 1, 5, 9, 2, 6, 5, 3]
# Valores únicos:
# {1, 2, 3, 4, 5, 6, 9}
# Existem 7 elementos únicos.
...
# ------------------------------------------------------------
Q05 = "B"
# O sort(reverse=True) organiza os números do maior para o menor:
# [9.0, 8.5, 7.0, 6.0, 5.5]
# O slicing [1:3] pega os índices 1 e 2:
# [8.5, 7.0]
...
# ------------------------------------------------------------
Q06 = "C"
# O comprehension percorre o dicionário usando .items().
# Apenas os itens com qtd == 0 entram na lista.
# "borracha" possui quantidade 0.
# Resultado:
# ["borracha"]
...
# ------------------------------------------------------------
Q07 = "A"
# difference() retorna os elementos que existem em turma_a
# mas NÃO existem em turma_b.
# turma_a:
# {"Ana", "Bruno", "Carlos", "Diana"}
# Removendo "Carlos" e "Diana":
# {"Ana", "Bruno"}
# O tamanho do conjunto é 2.
...
# O filtro if n % 2 == 0 pega apenas os pares:
# 2, 4, 6, 8, 10
...
# ------------------------------------------------------------
Q09 = "D"
# empresa["equipes"].values() percorre os dicionários internos:
# {"lider": "Hygo", "membros": 5}
# {"lider": "Ana",  "membros": 3}
# O sum() soma os valores de "membros":
# 5 + 3 = 8
...
# ------------------------------------------------------------
Q10 = "C"
# O código calcula a média de cada aluno.
#
# Carlos: (7+8+9)/3 = 8
# Beatriz: (10+10+9)/3 = 9.66
# Diego: (5+6+4)/3 = 5
#
# Apenas Carlos e Beatriz têm média >= 7.
# Resultado:
# ["Carlos", "Beatriz"]
...
# ------------------------------------------------------------
Q11 = "C"
# A função somar() calcula o valor,
# mas não possui return.
# Toda função sem return devolve None por padrão.
...
# ------------------------------------------------------------
Q12 = "C"
# mensagem="Olá" é o valor padrão.
# saudar("Ana") usa o padrão:
# "Olá, Ana!"
# saudar("Bruno", "Bom dia")
...
# ------------------------------------------------------------
Q13 = "C"
# Existe uma variável global x = 10.
# Dentro da função, é criada outra variável local x = 99.
# A função imprime 99.
# Fora da função, o x global continua sendo 10.
...
# ------------------------------------------------------------
Q14 = "C"
# *valores junta todos os argumentos em uma tupla:
# (3, 7, 1, 9, 2)
# max(valores) = 9
# min(valores) = 1
# 9 - 1 = 8
...
# ------------------------------------------------------------
Q15 = "B"
# A função aplicar() recebe outra função como parâmetro.
# dobrar(n) multiplica cada número por 2.
# [1,2,3,4] → [2,4,6,8]
...
# ------------------------------------------------------------
Q17 = "A"
# **dados transforma os argumentos em dicionário:
# {"nome":"Hygo", "cargo":"Professor", "ativo":True}
#
# O comprehension deixa todas as chaves maiúsculas:
# {"NOME":"Hygo", "CARGO":"Professor", "ATIVO":True}
#
# info.get("CARGO") retorna "Professor".
#
# registrar.__doc__ pega a docstring da função.
# [:10] pega os primeiros 10 caracteres:
# "Registra i"
