...
def obter_turma():
    ...
    while True:
        ...
        if validar_turma(nome_turma):
            ...
            print("Nome de turma inválido. Tente outro nome ou digite 'sair' para encerrar")
...
def obter_aluno():
    ...
    while True:
        ...
        if validar_aluno(nome_aluno):
            ...
            print("Nome de aluno inválido. Tente outro nome ou digite 'sair' para encerrar")
...
def obter_nota(numero_da_nota):
    ...
    while True:
        valor_digitado = input(f"Digite a nota {numero_da_nota}: ")
